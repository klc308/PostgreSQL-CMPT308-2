...
DROP TABLE IF EXISTS People, VendorContacts, Staff, Customers, Vendors, Addresses, Products, 
	Producthistory, Inventory, Arrangements, ArrangementItems, ArrangementItemsList CASCADE;
...
INSERT INTO Addresses(peopleId, street1, street2, city, state, zip)
	VALUES('people001', NULL, '15 Applewood Drive', 'Fruit Heights', 'Utah', '84037'),
	      ('people002', NULL, '760 Killian Road', 'Akron', 'Ohio', '44319'),
		  ('people003', NULL, '7225 NW 25th Street', 'Miami', 'Florida', '33122'),
		  ('people004', NULL, '456 Mantle Circle', 'Poughkeepsie', 'New York', '12601'),
		  ('people005', NULL, '23 Alamo Road', 'Rhinebeck', 'New York', '12572-1234'),
		  ('people006', 'Royal Crest Apartments', '22B Royal Crest Place', 'Hyde Park', 'New York', '12538-2256'),
		  ('people007', 'Park Manor Apartments', '4568 Springwood Drive', 'Hyde Park', 'New York', '12538-4568'),
		  ('people008', NULL, '45 Zachary Way', 'Poughkeepsie', 'New York',  '12602-4545'),
		  ('people009', 'Cherry Condominiums', '21 Cherry Hill Road', 'Red Hook', 'New York', '12571'),
	      ('people010', NULL, '62 Hilltop Road', 'Rhinecliff', 'New York', '12573'), 
		  ('people011', NULL, '86B Church Street', 'Poughkeepsie', 'New York', '12602'),		  
		  ('people012', NULL, '91-28B Main Street', 'Beacon', 'New York', '12508-1928');
		  
INSERT INTO Products(vendorProductId, vendorId, productType, productName, productSize, productColor, productQty, 
                    currentCostUSD, productDesc)
...
INSERT INTO ProductHistory(vendorProductId, historyCostUSD, dateBought)	
...
INSERT INTO Inventory(vendorProductId, itemId, invQty)
...
SELECT s.peopleId, s.dateHired, s.hiredPosition, s.dateLeft, s.currentPosition, s.cellPhone,
       p.firstName, p.lastName, p.phone, p.phoneType, p.email, a.street1, a.street2, a.city, 
	   a.state, a.zip
FROM Staff s,
	 People p,
	 Addresses a
...
AS
SELECT c.peopleId, p.firstName, p.lastName, p.phone, p.phoneType, p.email, a.street1, 
...
BEGIN
	OPEN resultset FOR
		SELECT i.itemId, ail.itemQty, i.invQty, i.vendorProductID, v.vendorName,
...
BEGIN		
	IF productNew = 'Y' THEN
		INSERT INTO Products 
			VALUES (newVendorProductId, vendorId, newProductType, newProductName, 
					newProductSize, newProductColor, newProductQty, newCurrentCostUSD, 
					newProductDesc);
	...
	IF productNew = 'N' THEN
		...
		UPDATE Inventory SET
			...
			WHERE vendorproductId = newVendorProductId and itemId = newItemId;
	END IF;			
END
$$
LANGUAGE plpgsql;
...
UPDATE table_name SET column_name = 'what to change to' WHERE column_name is NULL
...
-- SELECT AddPeople('peopleId', 'firstName', 'lastName', 'phone', 'phoneType', 
--	'email', 'street1', 'street2', 'city', 'state', 'zip', dateHired, 
